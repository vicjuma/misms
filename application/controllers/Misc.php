...
class Misc extends CI_Controller{
    ...
    public function dldb(){
        ...
        $file_path = BASEPATH . "sqlite/2835011_misms.sqlite";//link to db file
    ...
    public function importdb(){
        ...
        if(file_exists(BASEPATH."sqlite/2835011_misms.sqlite")){
            copy(BASEPATH."sqlite/2835011_misms.sqlite", BASEPATH."sqlite/backups/".time().".sqlite");
        }
        
        $config['upload_path'] = BASEPATH . "sqlite/";//db files are stored in the basepath
        $config['allowed_types'] = 'sqlite';
        $config['file_ext_tolower'] = TRUE;
        $config['file_name'] = "2835011_misms.sqlite";
